...
public class CardScannerPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware, PluginRegistry.ActivityResultListener {
    ...
    public final static String METHOD_CHANNEL_NAME = "himaf/civ_idcard_scanner";
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        if ("scan_card".equals(call.method)) {
            if (activity == null) {
                result.error("no_activity", "civ_idcard_scanner plugin requires a foreground activity.", null);
                return;
            }
